...
from parham_core import PhmMnist, PhmPlottingCallback, load_datasets, save_model
#############################
...
valid_loader = DataLoader(
    valid_dataset, batch_size=batch_size, num_workers=2, shuffle=True)
...
exp_q4.train(train_generator=train_loader, valid_generator=valid_loader,
